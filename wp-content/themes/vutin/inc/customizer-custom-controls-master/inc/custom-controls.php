...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 class Skyrocket_Image_Checkbox_Custom_Control extends WP_Customize_Control {
 		 ...
 		 */
  		public function enqueue() {
 			wp_enqueue_style( 'skyrocket_custom_controls_css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer-custom-controls-master/css/customizer.css', array(), '1.0', 'all' );
  		}
 		/**
	...
	class Skyrocket_Single_Accordion_Custom_Control extends WP_Customize_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket_custom_controls_js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer-custom-controls-master/js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'skyrocket_custom_controls_css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer-custom-controls-master/css/customizer.css', array(), '1.0', 'all' );
	...
	class Skyrocket_Slider_Custom_Control extends WP_Customize_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket_custom_controls_js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer-custom-controls-master/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'skyrocket_custom_controls_css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer-custom-controls-master/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	...
	class Skyrocket_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'skyrocket_custom_controls_js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer-custom-controls-master/js/customizer.js', array( 'skyrocket_select2_js' ), '1.0', true );
			wp_enqueue_style( 'skyrocket_custom_controls_css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer-custom-controls-master/css/customizer.css', array(), '1.1', 'all' );
	...
	class Skyrocket_Customize_Alpha_Color_Control extends WP_Customize_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket_custom_controls_js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer-custom-controls-master/js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'skyrocket_custom_controls_css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer-custom-controls-master/css/customizer.css', array( 'wp-color-picker' ), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
